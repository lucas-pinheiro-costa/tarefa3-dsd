...
class MonitorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateData = channel.unary_unary(
                ...
                _registered_method=True)
        self.StreamRealtimeSensorData = channel.unary_stream(
                '/MonitorService/StreamRealtimeSensorData',
                request_serializer=contrato__pb2.StreamRequest.SerializeToString,
                response_deserializer=contrato__pb2.RealtimeSensorData.FromString,
                _registered_method=True)
        self.ListAllSensors = channel.unary_unary(
                '/MonitorService/ListAllSensors',
                request_serializer=contrato__pb2.EmptyRequest.SerializeToString,
                response_deserializer=contrato__pb2.AllSensorsResponse.FromString,
                _registered_method=True)
...
class MonitorServiceServicer(object):
    ...
    def StreamRealtimeSensorData(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MonitorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamRealtimeSensorData': grpc.unary_stream_rpc_method_handler(
                    servicer.StreamRealtimeSensorData,
                    request_deserializer=contrato__pb2.StreamRequest.FromString,
                    response_serializer=contrato__pb2.RealtimeSensorData.SerializeToString,
            ),
            'ListAllSensors': grpc.unary_unary_rpc_method_handler(
                    servicer.ListAllSensors,
                    request_deserializer=contrato__pb2.EmptyRequest.FromString,
                    response_serializer=contrato__pb2.AllSensorsResponse.SerializeToString,
            ),
    }
...
class MonitorService(object):
    ...
    @staticmethod
    def StreamRealtimeSensorData(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/MonitorService/StreamRealtimeSensorData',
            contrato__pb2.StreamRequest.SerializeToString,
            contrato__pb2.RealtimeSensorData.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ListAllSensors(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/MonitorService/ListAllSensors',
            contrato__pb2.EmptyRequest.SerializeToString,
            contrato__pb2.AllSensorsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
